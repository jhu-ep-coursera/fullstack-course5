...
You also need to create your own instance of restaurant-server on Heroku, using [github.com/jhu-ep-coursera/restaurant-server](https://github.com/jhu-ep-coursera/restaurant-server) .

You will obtain https://YOUR-CHOSEN-SUBDOMAIN.herokuapp.com/, where `YOUR-CHOSEN-SUBDOMAIN` is the subdomain discussed in Lecture50 (Restaurant Server Setup)
